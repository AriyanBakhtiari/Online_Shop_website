    ...
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        builder.HasData(new Product
            ...
            new Product
            {
                ...
                QuantityInStock = 10,
                Description =
                    "تی شرت های نخی فلوریزا همواره از محبوبترین تی شرت ها بوده است و چون با کیفیت جنس بالا (100 درصد نخی پنبه ای و بدون پلی استر) تولیدمی شود همواره طرفداران زیادی دارد. ساده و شیک بودن آن در کنار تنوع در سایز بندی، این نوع تی شرت را همواره به عنوان یکی از محبوبترین کادوها به خصوص در میان مردم مطرح کرده است.این محصول در تمامی سایزهای S، M، L، XL، XXL، XXXL ارائه می گردد. .................................................................................................به سایزبندی تی شرت توجه شود که فقط و فقط مختص پنل فلوریزا می باشد ."
            }
            , new Product
            {
                Id = 3,
            ...
            new Product
            {
                ...
                QuantityInStock = 10,
                Description =
                    "این کفش با طرح رنگ چشم نواز دارای متریال و دوخت بسیار با کیفیت است. زیره لاستیکی مورد استفاده در این کفش باعث دوام بالا می گردد. طراحی کفش بگونه ای است که راحتی پای شما را در تمام مدت روز به همراه دارد."
            },
            new Product
            {
                Id = 8,
                ...
                QuantityInStock = 10,
                Description =
                    "این کفش فوق العاده راحت بوده و راحتی را با یک زیره میانی متمایز EVA و Boost آدیداس افزایش می دهد. رویه این کفش Ripstop آدیداس با روکش های جیر مصنوعی می باشد. زیره لاستیکی برای استیبل بودن و احساس پایداری شما در انواع حرکات ورزشی می باشد."
            },
            new Product
            {
                Id = 9,
